...
const HomeScreen = ({navigation}) => {
  ...
  const { token, usuario, setToken, refreshHuerto, setRefreshHuerto} = useAppContext ()
  ...
  return (
    <SafeAreaView style={styles.Container}>
        <View style={{flex: 1, marginHorizontal: 22, justifyContent: "space-between"}}>
          ...
          {/* <TouchableOpacity style={styles.floatingButton} onPress={()=>navigation.navigate("HomeScreen")}>
